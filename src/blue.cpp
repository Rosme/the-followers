...
Blue::Blue(std::shared_ptr<Ressources> ressources, Window& window, Runner& player)
	: Ennemi(ressources, window, player, 0.1f) {
		m_sprite = ressources->aquireBlueFollower();
...
void Blue::update(sf::Time delta) {
